class CreditCardsController < ApplicationController
  ...
  def list_info
    @success = CreditCard.where(paid: true , refunded: false)
    @disputed = CreditCard.where(paid: true , refunded: true)
    @failed = CreditCard.where(paid: false , refunded: false)
  end
  ...
  private
    ...
    def credit_card_params
      params.require(:credit_card).permit(:paid, :amount, :currency, :refunded, :customer_id)
    end
end
